const filmography = [
    ...
    },
    {
        ...
        sinopse: 'Sam Lowry vive em um Estado futurista totalitário controlado pelos computadores e pela burocracia, onde todos são governados por fichas e cartões de crédito. Em meio à opressão, Sam acaba se apaixonando por Jill Layton, uma terrorista.',
        nota: '7.9',
        tag1: 'ficção científica',
        tag2: 'fantasia',
        logo1: 'star+.png',
    ...
    },
    {
        ...
        capa: 'C81',
        direcao: 'Wes Ball',
        sinopse: 'Depois de escapar do labirinto, Thomas e os garotos que o acompanharam em sua fuga encontram uma realidade bem diferente: a superfície da Terra foi queimada pelo Sol e eles precisam lidar com criaturas disformes chamadas Cranks.',
        nota: '6.3',
        tag1: 'ficção científica',
        tag2: 'ação',
        logo1: 'star+.png',
    ...
    {
        id: 85,
        name: 'Fuga de Nova York',
        age: '1991',
        duration: '1h 39m',
        capa: 'C85',
        direcao: 'John Carpenter',
        sinopse: 'Num futuro não muito distante, os governantes pretendem diminuir a criminalidade e transformam Nova York numa prisão de segurança máxima. Quando o avião do presidente é sequestrado e cai na ilha, a única esperança é um ex-combatente preso lá.',
        nota: '7.1',
        tag1: 'ação',
        tag2: 'ficção científica',
        logo1: 'primeVideo.png',
    ...
    },
    {
        ...
        capa: 'C86',
        direcao: 'Luc Besson',
        sinopse: 'Lucy é obrigada a contrabandear drogas dentro do estômago. Mas o corpo da jovem absorve as substâncias e ela passa a ter superpoderes, como telepatia, telecinesia, a ausência de dor e a capacidade de adquirir conhecimento instantaneamente.',
        nota: '6.4',
        tag1: 'ação',
        tag2: 'suspense',
        logo1: 'star+.png',
    ...
    },
    {
        ...
        capa: 'C87',
        direcao: 'Spike Jonze',
        sinopse: 'Em Ela, Theodore (Joaquin Phoenix) é um escritor solitário, que acaba de comprar um novo sistema operacional para seu computador. Para a sua surpresa, ele acaba se apaixonando pela voz deste programa informático, dando início a uma relação amorosa entre ambos. Esta história de amor incomum explora a relação entre o homem contemporâneo e a tecnologia.',
        nota: '8.0',
        tag1: 'ficção científica',
        tag2: 'romance',
        logo1: 'netflix.png',
    ...
    },
    {
        ...
        capa: 'C90',
        direcao: 'Joe Wright',
        sinopse: 'Anna Karenina, casada um alto funcionário do governo russo, envolve-se com o Conde Vronsky, oficial da cavalaria, chocando a alta sociedade de 1874. Ela pede o divórcio, mas o marido, além de se recusar a concedê-lo, ainda a impede de ver o filho.',
        nota: '',
        tag1: 'romance',
        tag2: 'drama',
        logo1: '',
    ...
    },
    {
        ...
        capa: 'C92',
        direcao: 'Doug Liman',
        sinopse: 'Em uma guerra contra alienígenas, William Cage descobre que tem a estranha habilidade de voltar no tempo, ficando preso em um eterno ciclo. Ele treina para usar suas novas habilidades, derrotar os invasores e acabar com a guerra.',
        nota: '',
        tag1: 'ficção científica',
        tag2: 'ação',
        logo1: '',
    ...
    },
    {
        ...
        capa: 'C94',
        direcao: 'Andrew Niccol',
        sinopse: 'A Terra foi colonizada por uma raça alienígena que controla a mente dos humanos e usa seus corpos como hospedeiros. A maioria da humanidade foi erradicada, mas quando Melanie se recusa a aceitar sua nova alma, uma caçada se inicia.',
        nota: '',
        tag1: 'ficção científica',
        tag2: 'romance',
        logo1: '',
    ...
    },
    {
        ...
        duration: '1h 40m',
        capa: 'C96',
        direcao: 'Peter Ramsey / Bob Persichetti / Rodney Rothman',
